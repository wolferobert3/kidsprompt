...
def monster_wrapper(image):
    ...
    dict_probs = model.predict(image, TEXT_CLASSES)
...
with gr.Blocks() as demo:
    ...
    with gr.Accordion(label="Scan your face to check admission status!", open=False):
        ...
        with gr.Row():
            ...
            outputs = gr.Label(num_top_classes=3, label="Output", name="output")
            output_image = gr.Image(label="Output", value='admission_images/question_mark.png')
